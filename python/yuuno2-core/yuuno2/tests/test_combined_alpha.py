...
from yuuno2.format import RawFormat, RGB24, GRAY8, Size
from yuuno2.tests.mocks import MockFrame, MockClip
from yuuno2.clips.combined_alpha import AlphaFrame, AlphaClip


RGBA32 = RawFormat("video", RawFormat.ColorFamily.RGB,  ["r", "g", "b", "a"], True, RawFormat.SampleType.INTEGER, 8, 1, True, (0, 0))
